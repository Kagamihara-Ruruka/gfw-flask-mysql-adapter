...
class PresentationDeploymentTests(unittest.TestCase):
    ...
    def test_deployment_profile_is_the_formal_sea1_truth(self) -> None:
        ...
        self.assertEqual("tailscale_subnet_direct", profile["connectivity"]["mode"])
        self.assertTrue(profile["connectivity"]["tailscale_required"])
        self.assertEqual(["192.168.32.201/32"], profile["connectivity"]["required_routes"])
        self.assertTrue(profile["connectivity"]["public_ssh_forbidden"])
